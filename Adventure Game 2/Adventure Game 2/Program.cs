...
namespace ConsoleApp8
{
    internal class GameMainObject    //This is the main game object responsible for rendering the scene
    {
        ...
        public GameMainObject
            ...
            SoundPlayer powerDown, SoundPlayer hello, SoundPlayer helloError, SoundPlayer helloError2, SoundPlayer helpMe, SoundPlayer dontCaught, SoundPlayer happenBad
            )
        {
            this.map = map;
            this.player = player;
    ...
    internal class Program
    {
        ...
        {
            char[] bag = { 'X', 'X', 'X', 'X', 'X' };
            SoundPlayer soundtrack = new SoundPlayer(@"<enter file address here>\soundtrack.wav");
            SoundPlayer win = new SoundPlayer(@"<enter file address here>\win.wav");
            SoundPlayer lose = new SoundPlayer(@"<enter file address here>\lose.wav");
            SoundPlayer keyboard = new SoundPlayer(@"<enter file address here>\keyboard.wav");
            SoundPlayer error = new SoundPlayer(@"<enter file address here>\error.wav");
            SoundPlayer helpMorze = new SoundPlayer(@"<enter file address here>\help_me.wav");
            SoundPlayer caughtMorze = new SoundPlayer(@"<enter file address here>\dont_get_caught.wav");
            SoundPlayer happenMorze = new SoundPlayer(@"<enter file address here>\happen.wav");
            SoundPlayer hello = new SoundPlayer(@"<enter file address here>\hello.wav");
            SoundPlayer helloError = new SoundPlayer(@"<enter file address here>\error_hello.wav");
            SoundPlayer helloError2 = new SoundPlayer(@"<enter file address here>\error_hello2.wav");
            SoundPlayer powerDown = new SoundPlayer(@"<enter file address here>\power_down.wav");
            char[,] map =
            {
                    {'#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#','#'},
                    {'#',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ','#'},
            ...
            try
            {
                ...
                GameMainObject game = new GameMainObject
                    ...
                    powerDown, hello, helloError, helloError2, helpMorze, caughtMorze, happenMorze
                    );
